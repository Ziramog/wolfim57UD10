...
(function () {
  ...
  const translations = {
    en: {
      ...
      'pricing.p3.tag': 'For inventory',
      'pricing.p3.title': 'Catalog',
      'pricing.p3.f1': 'Custom Design',
      'pricing.p3.f2': 'Catalog of Properties, Cars, Lots or Products',
      'pricing.p3.f3': 'Individual Cards',
      'pricing.p3.f4': 'Filters & Search',
      'pricing.p3.f5': 'Admin Panel',
      'pricing.p3.f6': 'WhatsApp per Item',
      'pricing.p3.f7': 'SEO per Card',
      'pricing.p3.f8': 'Hosting + SSL Included',
      'pricing.p3.f9': '3-4 Weeks Delivery',
      'pricing.p3.note': 'Ideal for real estate, car agencies, land developments, machinery, spare parts and inventory-based businesses.',
      'pricing.p3.disclaimer': 'Final price depends on number of items, filters and integrations.'
      'pricing.p4.tag': 'Full online store',
      'pricing.p4.title': 'Ecommerce',
      'pricing.p4.f1': 'Custom Design',
      'pricing.p4.f2': 'Products, Cart & Checkout',
      'pricing.p4.f3': 'Payment Gateway',
      'pricing.p4.f4': 'Order Management',
    ...
    es: {
      ...
      'pricing.p1.f4': 'WhatsApp + Formulario de Contacto',
      ...
      'pricing.p3.tag': 'Para inventario',
      'pricing.p3.title': 'Catálogo',
      'pricing.p3.f1': 'Diseño Personalizado',
      'pricing.p3.f2': 'Catálogo de Propiedades, Autos, Lotes o Productos',
      'pricing.p3.f3': 'Fichas Individuales',
      'pricing.p3.f4': 'Filtros y Buscador',
      'pricing.p3.f5': 'Panel de Administración',
      'pricing.p3.f6': 'WhatsApp por Ítem',
      'pricing.p3.f7': 'SEO por Ficha',
      'pricing.p3.f8': 'Hosting + SSL Incluido',
      'pricing.p3.f9': 'Entrega en 3-4 Semanas',
      'pricing.p3.note': 'Ideal para inmobiliarias, agencias de autos, loteos, maquinaria, repuestos y negocios con inventario.',
      'pricing.p3.disclaimer': 'El precio final depende de la cantidad de ítems, filtros e integraciones.'
      'pricing.p4.tag': 'Tienda online completa',
      'pricing.p4.title': 'Ecommerce',
      'pricing.p4.f1': 'Diseño Personalizado',
      'pricing.p4.f2': 'Productos, Carrito y Checkout',
      'pricing.p4.f3': 'Pasarela de Pagos',
      'pricing.p4.f4': 'Gestión de Pedidos',
