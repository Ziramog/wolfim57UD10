...
(function () {
  ...
  const translations = {
    en: {
      ...
      'pricing.p1.tag': 'SMBs & PROFESSIONALS',
      'pricing.p1.title': 'Commercial Presence',
      'pricing.p1.f1': 'Compact premium site',
      'pricing.p1.f2': 'Clear value proposition',
      'pricing.p1.f3': 'Services + contact',
      'pricing.p1.f4': 'WhatsApp + form',
      'pricing.p1.f5': 'Basic SEO + tracking',
      ...
      'pricing.p2.f3': 'Gallery, video or tour',
      'pricing.p2.f4': 'Lots, status and prices',
      'pricing.p2.f5': 'Initial Meta campaign',
      'pricing.p2.note': 'For subdivisions, country clubs and private lands.',

      'pricing.p3.tag': 'CARS & DEALERSHIPS',
      'pricing.p3.title': 'AutoLead Catalog',
      'pricing.p3.f1': 'Unit catalog',
      'pricing.p3.f2': 'Individual sheets',
      'pricing.p3.f3': 'Photos, data and price',
      'pricing.p3.f4': 'WhatsApp per vehicle',
      'pricing.p3.f5': 'Update panel',
      'pricing.p3.note': 'For dealerships with changing stock.',

      'pricing.p4.tag': 'REAL ESTATE',
      'pricing.p4.title': 'Real Estate Portal',
      'pricing.p4.f1': 'Premium home',
      'pricing.p4.f2': 'Property catalog',
      'pricing.p4.f3': 'Individual sheets',
      'pricing.p4.f4': 'Filters / search',
      'pricing.p4.f5': 'CMS for properties',
      'pricing.p4.note': 'For sales, rentals, appraisals and investors.',

      'pricing.p5.tag': 'ECOMMERCE',
      'pricing.p5.title': 'Online Store',
      'pricing.p5.f1': 'Product catalog',
      'pricing.p5.f2': 'Cart + checkout',
      'pricing.p5.f3': 'Online payments',
      'pricing.p5.f4': 'Order management',
      'pricing.p5.f5': 'Admin panel',
      'pricing.p5.note': 'For businesses ready to sell online.',
    ...
    es: {
      ...
      'pricing.p1.tag': 'PYMES & PROFESIONALES',
      'pricing.p1.title': 'Presencia Comercial',
      'pricing.p1.f1': 'Sitio premium compacto',
      'pricing.p1.f2': 'Propuesta de valor clara',
      'pricing.p1.f3': 'Servicios + contacto',
      'pricing.p1.f4': 'WhatsApp + formulario',
      'pricing.p1.f5': 'SEO básico + medición',
      ...
      'pricing.p2.f3': 'Galería, video o recorrido',
      'pricing.p2.f4': 'Lotes, estados y precios',
      'pricing.p2.f5': 'Campaña Meta inicial',
      'pricing.p2.note': 'Para loteos, countries y tierras privadas.',

      'pricing.p3.tag': 'AUTOS & AGENCIAS',
      'pricing.p3.title': 'AutoLead Catálogo',
      'pricing.p3.f1': 'Catálogo de unidades',
      'pricing.p3.f2': 'Fichas individuales',
      'pricing.p3.f3': 'Fotos, datos y precio',
      'pricing.p3.f4': 'WhatsApp por vehículo',
      'pricing.p3.f5': 'Panel de actualización',
      'pricing.p3.note': 'Para agencias con stock cambiante.',

      'pricing.p4.tag': 'INMOBILIARIAS',
      'pricing.p4.title': 'Portal Inmobiliario',
      'pricing.p4.f1': 'Home premium',
      'pricing.p4.f2': 'Catálogo de propiedades',
      'pricing.p4.f3': 'Fichas individuales',
      'pricing.p4.f4': 'Filtros / buscador',
      'pricing.p4.f5': 'CMS para propiedades',
      'pricing.p4.note': 'Para venta, alquileres, tasaciones e inversores.',

      'pricing.p5.tag': 'ECOMMERCE',
      'pricing.p5.title': 'Tienda Online',
      'pricing.p5.f1': 'Catálogo de productos',
      'pricing.p5.f2': 'Carrito + checkout',
      'pricing.p5.f3': 'Pagos online',
      'pricing.p5.f4': 'Gestión de pedidos',
